...
import mons.urban.dataimport


class MonsUrbanDataimportLayer(PloneSandboxLayer):

    defaultBases = (PLONE_FIXTURE,)
    products = ('mons.urban.dataimport',
               )
    ...
    def setUpPloneSite(self, portal):
        ...
        applyProfile(portal, 'mons.urban.dataimport:testing')
...
FIXTURE = MonsUrbanDataimportLayer(
    name="FIXTURE"
    )
